...
import 'package:project2mobile/pages/transaksi.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
            IconButton(onPressed: (){}, icon: new Icon(Icons.markunread_outlined))
          ],
      ),
      body: Center(
        child: FutureBuilder(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (BuildContext context) => const Transaksi(),
              ));
        },
        tooltip: 'Increment',
        child: Text('Pesan'),
